...
@Service
public class StudentMappingService extends LahiMappingMetadataService {

    public StudentMappingService(MappingMetaDataRepository mappingMetaDataRepository, IntegrationSystemRepository integrationSystemRepository) {
