...
INSERT INTO mapping_group (name, integration_system_id, uuid, is_voided)
SELECT 'GeneralEncounter', id, uuid_generate_v4(), false
FROM integration_system WHERE name = 'bahmni'
ON CONFLICT DO NOTHING;
...
INSERT INTO mapping_type (name, integration_system_id, uuid, is_voided)
SELECT 'EncounterType', id, uuid_generate_v4(), false
FROM integration_system WHERE name = 'bahmni'
ON CONFLICT DO NOTHING;

-- Section 3: Encounter Type Mapping
-- -----------------------------------------------------
...
-- Section 4: Observation/Concept Mappings (13 concepts)
-- -----------------------------------------------------
