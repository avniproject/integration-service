...
//        distributionDTO.setDispatchStatus(dispatchStatusId);
        ...
        distributionDTO.setMaterialProvidedAsPartOfRahat((String) subject.getObservation(MATERIAL_PROVIDED_AS_PART_OF_RAHAT));
        ...
        /* vaapsi fields */
            ...
            distributionDTO.setIsCenteraSchoolAnganwadiLearning((String) subject.getObservation(IS_CENTRE_A_SCHOOL_ANGANWADI_LEARNING_CENTRE));
